...
const generateEngineers = engineers => {
    ...
    for (let i = 0; i < engineers.length; i++) {
        ...
        <article class="card">
            <div class="card-body">
                <h2 class="card-title">${engineers[0].name}</h2>
                <h3 class="card-subtitle">${getRole(engineers[0])}</h3
...
const generateInterns = interns => {
    ...
    for (let i = 0; i < interns.length; i++) {
        ...
        <article class="card">
            <div class="card-body">
                <h2 class="card-title">${interns[0].name}</h2>
                <h3 class="card-subtitle">${getRole(interns[0])}</h3
                <ul class="list-group list-group-flush">
        ...
        <main class="container my-5">
            ...
            <article class="card">
                <div class="card-body">
                    ...
                    <h3 class="card-subtitle">${getRole(manager[0])}</h3
                    <ul class="list-group list-group-flush">
